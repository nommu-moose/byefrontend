# src/byefrontend/widgets/code_box.py
...
class CodeBoxWidget(BFEFormCompatibleWidget):
    """
    A rich, live-highlighting code editor with colour pickers.
    It preserves all visual styles defined in *code_box.css*.
    """
    ...
    #  Rendering
    # ------------------------------------------------------------------ #
    def _render(                       # noqa: C901 (readability over 50 lines)
        self,
        name: str | None = None,
        value: Any = None,
        attrs=None,
